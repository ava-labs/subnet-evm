...
type WarpBackend interface {
	// AddWarpMessage signs [unsignedMessage] and adds it to the warp backend database
...
func (w *warpBackend) AddWarpMessage(unsignedMessage *avalancheWarp.UnsignedMessage) error {
