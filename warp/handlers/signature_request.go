...
func (*NoopSignatureRequestHandler) OnMessageSignatureRequest(_ context.Context, _ ids.NodeID, _ uint32, _ message.MessageSignatureRequest) ([]byte, error) {
	return nil, nil
}

func (*NoopSignatureRequestHandler) OnBlockSignatureRequest(_ context.Context, _ ids.NodeID, _ uint32, _ message.BlockSignatureRequest) ([]byte, error) {
	return nil, nil
}
