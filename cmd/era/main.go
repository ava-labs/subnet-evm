...
import (
	...
	"github.com/ava-labs/subnet-evm/internal/era"
...
func block(ctx *cli.Context) error {
	...
	val := ethapi.RPCMarshalBlock(block, ctx.Bool(txsFlag.Name), ctx.Bool(txsFlag.Name), params.SubnetEVMDefaultChainConfig)
