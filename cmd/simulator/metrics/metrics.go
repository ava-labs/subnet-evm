...
func (m *Metrics) ObserveTxIssue(secs float64) {
	m.IssuanceTxTimes.Observe(secs)
}

func (m *Metrics) ObserveTxConfirm(secs float64) {
	m.ConfirmationTxTimes.Observe(secs)
}

func (m *Metrics) ObserveTxLatency(secs float64) {
	m.IssuanceToConfirmationTxTimes.Observe(secs)
}
