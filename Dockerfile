...
ARG CURRENT_BRANCH
# Re-declare VMID ARG in order to inherit global value set above
ARG VMID
...
RUN export SUBNET_EVM_COMMIT=$SUBNET_EVM_COMMIT && export CURRENT_BRANCH=$CURRENT_BRANCH && ./scripts/build.sh /build/$VMID
