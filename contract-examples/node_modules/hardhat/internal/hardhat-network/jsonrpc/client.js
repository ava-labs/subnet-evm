...
class JsonRpcClient {
    ...
    async getDebugTraceTransaction(transactionHash) {
        return this._perform("debug_traceTransaction", [ethereumjs_util_1.bufferToHex(transactionHash)], t.object, () => undefined);
    }
    // Storage key must be 32 bytes long
    async getStorageAt(address, position, blockNumber) {
        return this._perform("eth_getStorageAt", [
            address.toString(),
            base_types_1.numberToRpcQuantity(position),
            base_types_1.numberToRpcQuantity(blockNumber),
        ], base_types_1.rpcData, () => blockNumber);
    }
    async getBlockByNumber(blockNumber, includeTransactions = false) {
        if (includeTransactions) {
            return this._perform("eth_getBlockByNumber", [base_types_1.numberToRpcQuantity(blockNumber), true], io_ts_1.nullable(block_1.rpcBlockWithTransactions), (block) => { var _a; return (_a = block === null || block === void 0 ? void 0 : block.number) !== null && _a !== void 0 ? _a : undefined; });
        }
        return this._perform("eth_getBlockByNumber", [base_types_1.numberToRpcQuantity(blockNumber), false], io_ts_1.nullable(block_1.rpcBlock), (block) => { var _a; return (_a = block === null || block === void 0 ? void 0 : block.number) !== null && _a !== void 0 ? _a : undefined; });
    }
    async getBlockByHash(blockHash, includeTransactions = false) {
        if (includeTransactions) {
            return this._perform("eth_getBlockByHash", [ethereumjs_util_1.bufferToHex(blockHash), true], io_ts_1.nullable(block_1.rpcBlockWithTransactions), (block) => { var _a; return (_a = block === null || block === void 0 ? void 0 : block.number) !== null && _a !== void 0 ? _a : undefined; });
        }
        return this._perform("eth_getBlockByHash", [ethereumjs_util_1.bufferToHex(blockHash), false], io_ts_1.nullable(block_1.rpcBlock), (block) => { var _a; return (_a = block === null || block === void 0 ? void 0 : block.number) !== null && _a !== void 0 ? _a : undefined; });
    }
    async getTransactionByHash(transactionHash) {
        return this._perform("eth_getTransactionByHash", [ethereumjs_util_1.bufferToHex(transactionHash)], io_ts_1.nullable(transaction_1.rpcTransaction), (tx) => { var _a; return (_a = tx === null || tx === void 0 ? void 0 : tx.blockNumber) !== null && _a !== void 0 ? _a : undefined; });
    }
    async getTransactionCount(address, blockNumber) {
        return this._perform("eth_getTransactionCount", [ethereumjs_util_1.bufferToHex(address), base_types_1.numberToRpcQuantity(blockNumber)], base_types_1.rpcQuantity, () => blockNumber);
    }
    async getTransactionReceipt(transactionHash) {
        return this._perform("eth_getTransactionReceipt", [ethereumjs_util_1.bufferToHex(transactionHash)], io_ts_1.nullable(receipt_1.rpcTransactionReceipt), (tx) => { var _a; return (_a = tx === null || tx === void 0 ? void 0 : tx.blockNumber) !== null && _a !== void 0 ? _a : undefined; });
    }
    async getLogs(options) {
        ...
        return this._perform("eth_getLogs", [
            {
                fromBlock: base_types_1.numberToRpcQuantity(options.fromBlock),
                toBlock: base_types_1.numberToRpcQuantity(options.toBlock),
                address,
                topics,
            },
    ...
    async getAccountData(address, blockNumber) {
        const results = await this._performBatch([
            {
                method: "eth_getCode",
                params: [address.toString(), base_types_1.numberToRpcQuantity(blockNumber)],
    ...
    async _getFromDiskCache(forkCachePath, cacheKey, tType) {
        ...
        if (rawResult !== undefined) {
            return decodeJsonRpcResponse_1.decodeJsonRpcResponse(rawResult, tType);
        }
    }
    async _getBatchFromDiskCache(forkCachePath, cacheKey, tTypes) {
        ...
        return rawResults.map((r, i) => decodeJsonRpcResponse_1.decodeJsonRpcResponse(r, tTypes[i]));
    }
