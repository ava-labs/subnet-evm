...
class TxPool {
    ...
    removeTransaction(txHash) {
        ...
        const pendingForAddress = (_a = this._getPendingForAddress(senderAddress)) !== null && _a !== void 0 ? _a : immutable_1.List();
        const queuedForAddress = (_b = this._getQueuedForAddress(senderAddress)) !== null && _b !== void 0 ? _b : immutable_1.List();
    ...
    _addPendingTransaction(tx) {
        ...
        if (!replaced) {
            const { newPending, newQueued } = reorganizeTransactionsLists_1.reorganizeTransactionsLists(accountTransactions.push(serializedTx), (_b = this._getQueuedForAddress(hexSenderAddress)) !== null && _b !== void 0 ? _b : immutable_1.List(), (stx) => this._deserializeTransaction(stx).data.nonce);
            this._setPendingForAddress(hexSenderAddress, newPending);
            this._setQueuedForAddress(hexSenderAddress, newQueued);
        }
        this._setTransactionByHash(ethereumjs_util_1.bufferToHex(tx.hash()), serializedTx);
    }
