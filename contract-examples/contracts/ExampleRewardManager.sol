...
contract ExampleRewardManagerTest is DSTest {
  ...
  function test_sendFeesToBlackhole() public {
    blackholeBalance = BLACKHOLE_ADDRESS.balance;
  }
  ...
  function test_doesNotSetRewardAddressBeforeEnabled() public {
    ...
    assertEq(rewardManager.readAllowList(exampleAddress), 0);
  ...
  function test_setEnabled() public {
    ...
    assertEq(rewardManager.readAllowList(exampleAddress), 1);
  }
