...
func TestVerifyWithChainConfig(t *testing.T) {
	...
	badConfig.PrecompileUpgrades = append(
		...
		PrecompileUpgrade{
			Config: txallowlist.NewDisableTxAllowListConfig(big.NewInt(5)),
		},
	)
	...
	badConfig.PrecompileUpgrades = append(
		badConfig.PrecompileUpgrades,
		PrecompileUpgrade{
			Config: txallowlist.NewTxAllowListConfig(big.NewInt(5), admins, nil),
		},
	)
	err = badConfig.Verify()
...
func TestVerifyPrecompileUpgrades(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			upgrades: []PrecompileUpgrade{
				{
					Config: txallowlist.NewTxAllowListConfig(big.NewInt(1), admins, nil),
				},
				{
					Config: txallowlist.NewDisableTxAllowListConfig(big.NewInt(2)),
				},
			},
			expectedError: "",
		},
		{
			...
			upgrades: []PrecompileUpgrade{
				...
				{
					Config: txallowlist.NewTxAllowListConfig(big.NewInt(3), admins, admins),
				},
			},
		...
		},
		{
			...
			upgrades: []PrecompileUpgrade{
				{
					Config: feemanager.NewFeeManagerConfig(big.NewInt(3), admins, nil,
		...
		},
		{
			...
			upgrades: []PrecompileUpgrade{
				...
				{
					Config: feemanager.NewFeeManagerConfig(big.NewInt(1), admins, nil, nil),
				},
			},
			expectedError: "",
		},
		{
			...
			upgrades: []PrecompileUpgrade{
				{
					Config: txallowlist.NewTxAllowListConfig(big.NewInt(2), admins, nil),
				},
				{
					Config: feemanager.NewFeeManagerConfig(big.NewInt(1), admins, nil, nil),
				},
		...
		},
		{
			...
			upgrades: []PrecompileUpgrade{
				...
				{
					Config: txallowlist.NewDisableTxAllowListConfig(big.NewInt(1)),
				},
			},
...
func TestVerifyRequiresSortedTimestamps(t *testing.T) {
	...
	config.PrecompileUpgrades = []PrecompileUpgrade{
		...
		{
			Config: deployerallowlist.NewContractDeployerAllowListConfig(big.NewInt(1), admins, nil),
		},
	}
