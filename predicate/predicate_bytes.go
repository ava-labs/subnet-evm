...
func GetPredicateResultBytes(extraData []byte) ([]byte, bool) {
	// Prior to the Durango, the VM enforces the extra data is smaller than or equal to this size.
	// After the Durango, the VM pre-verifies the extra data past the dynamic fee rollup window is
	// valid.
