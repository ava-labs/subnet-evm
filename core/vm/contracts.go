...
var PrecompiledContractsHomestead = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{0x4}): newWrappedPrecompiledContract(&dataCopy{}),
}
...
var PrecompiledContractsByzantium = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{0x3}): newWrappedPrecompiledContract(&ripemd160hash{}),
	common.BytesToAddress([]byte{0x4}): newWrappedPrecompiledContract(&dataCopy{}),
	common.BytesToAddress([]byte{0x5}): newWrappedPrecompiledContract(&bigModExp{eip2565: false}),
	common.BytesToAddress([]byte{0x6}): newWrappedPrecompiledContract(&bn256AddByzantium{}),
	common.BytesToAddress([]byte{0x7}): newWrappedPrecompiledContract(&bn256ScalarMulByzantium{}),
	common.BytesToAddress([]byte{0x8}): newWrappedPrecompiledContract(&bn256PairingByzantium{}),
}
...
var PrecompiledContractsIstanbul = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{0x4}): newWrappedPrecompiledContract(&dataCopy{}),
	common.BytesToAddress([]byte{0x5}): newWrappedPrecompiledContract(&bigModExp{eip2565: false}),
	common.BytesToAddress([]byte{0x6}): newWrappedPrecompiledContract(&bn256AddIstanbul{}),
	common.BytesToAddress([]byte{0x7}): newWrappedPrecompiledContract(&bn256ScalarMulIstanbul{}),
	common.BytesToAddress([]byte{0x8}): newWrappedPrecompiledContract(&bn256PairingIstanbul{}),
	common.BytesToAddress([]byte{0x9}): newWrappedPrecompiledContract(&blake2F{}),
}
...
var PrecompiledContractsBerlin = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{0x3}): newWrappedPrecompiledContract(&ripemd160hash{}),
	common.BytesToAddress([]byte{0x4}): newWrappedPrecompiledContract(&dataCopy{}),
	common.BytesToAddress([]byte{0x5}): newWrappedPrecompiledContract(&bigModExp{eip2565: true}),
	common.BytesToAddress([]byte{0x6}): newWrappedPrecompiledContract(&bn256AddIstanbul{}),
	common.BytesToAddress([]byte{0x7}): newWrappedPrecompiledContract(&bn256ScalarMulIstanbul{}),
	common.BytesToAddress([]byte{0x8}): newWrappedPrecompiledContract(&bn256PairingIstanbul{}),
	common.BytesToAddress([]byte{0x9}): newWrappedPrecompiledContract(&blake2F{}),
...
var PrecompiledContractsCancun = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{0x8}): newWrappedPrecompiledContract(&bn256PairingIstanbul{}),
	common.BytesToAddress([]byte{0x9}): newWrappedPrecompiledContract(&blake2F{}),
	common.BytesToAddress([]byte{0xa}): newWrappedPrecompiledContract(&kzgPointEvaluation{}),
}
...
func init() {
	...
	addrsList = append(addrsList, PrecompiledAddressesPrague...)
