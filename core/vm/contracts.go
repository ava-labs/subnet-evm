...
type PrecompiledContract interface {
	...
	Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) // Run runs the precompiled contract
}
...
func ActivePrecompiles(rules params.Rules) []common.Address {
	...
	case rules.IsIstanbul:
		res = PrecompiledAddressesIstanbul
	case rules.IsByzantium:
		res = PrecompiledAddressesByzantium
	default:
...
func RunPrecompiledContract(accessibleState contract.AccessibleState, p PrecompiledContract, input []byte, suppliedGas uint64) (ret []byte, remainingGas uint64, err error) {
	gasCost := p.RequiredGas(input)
	if suppliedGas < gasCost {
		return nil, 0, vmerrs.ErrOutOfGas
	}
	suppliedGas -= gasCost
	output, err := p.Run(accessibleState, input)
...
func (c *ecrecover) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *sha256hash) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *ripemd160hash) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *dataCopy) Run(accessibleState contract.AccessibleState, in []byte) ([]byte, error) {
	return in, nil
}
...
func (c *bigModExp) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
	var (
...
func (c *bn256AddIstanbul) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bn256AddByzantium) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
	return runBn256Add(input)
}
...
func (c *bn256ScalarMulIstanbul) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bn256ScalarMulByzantium) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
	return runBn256ScalarMul(input)
}
...
func (c *bn256PairingIstanbul) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bn256PairingByzantium) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
	return runBn256Pairing(input)
}
...
func (c *blake2F) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bls12381G1Add) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bls12381G1Mul) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bls12381G1MultiExp) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bls12381G2Add) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bls12381G2Mul) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bls12381G2MultiExp) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bls12381Pairing) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bls12381MapG1) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
func (c *bls12381MapG2) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *createClient) RequiredGas(input []byte) uint64 {
	return params.CreateClient
}

func (c *createClient) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
	/*
		input
...
func (c *upgradeClient) Run(accessibleState contract.AccessibleState, input []byte) ([]byte, error) {
	...
	*/
	...
	if err != nil {
		return nil, fmt.Errorf("error unmarshalling upgraded ConsensusState: %w", err)
	}
	...
	if !upgradedClient.GetLatestHeight().GT(lastHeight) {
		return nil, fmt.Errorf("upgraded client height %s must be at greater than current client height %s", upgradedClient.GetLatestHeight(), lastHeight)
	}
	...
	if err := marshaler.Unmarshal(proofUpgradeConsStateByte, &merkleProofConsState); err != nil {
		return nil, fmt.Errorf("could not unmarshal consensus state merkle proof: %v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("could not marshal consensus state: %v", err)
	}
	...
	if err := merkleProofConsState.VerifyMembership(clientState.ProofSpecs, consensusState.GetRoot(), upgradeConsStatePath, bz); err != nil {
		return nil, fmt.Errorf("consensus state proof failed. Path: %s", upgradeConsStatePath.Pretty())
	}
	...
	if err := newClientState.Validate(); err != nil {
		return nil, fmt.Errorf("updated client state failed basic validation")
	}
