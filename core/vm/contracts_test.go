...
func TestPrecompiledAddOne(t *testing.T)             { testJson("addOne", "64", t) }
...
func BenchmarkPrecompiledAddOne(b *testing.B)             { benchJson("addOne", "64", b) }
...
func TestPrecompiledAddOneFail(t *testing.T)             { testJsonFail("addOne", "64", t) }
