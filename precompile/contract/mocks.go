...
//
//	mockgen -package=contract -destination=precompile/contract/mocks.go github.com/ethereum/go-ethereum/precompile/contract BlockContext,AccessibleState,StateDB
//
