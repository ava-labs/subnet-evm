...
// adds specific configuration for HubbleConfigManager.
type Config struct {
...
// HubbleConfigManager with the given [admins] as members of the allowlist .
...
// that disables HubbleConfigManager.
...
// Key returns the key for the HubbleConfigManager precompileconfig.
