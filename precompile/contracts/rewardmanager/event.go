...
func PackRewardAddressEvent(sender common.Address, reward common.Address) ([]common.Hash, []byte, error) {
	return RewardManagerABI.PackEvent("RewardAddress", sender, reward)
}

// UnpackRewardAddressEvent won't be generated because the event does not have any non-indexed data.
