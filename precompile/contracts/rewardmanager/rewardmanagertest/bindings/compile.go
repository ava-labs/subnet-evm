...
//go:generate solc-v0.8.30 -o artifacts --overwrite --abi --bin --base-path ../../../../../.. contracts/=contracts/ precompile/=precompile/ --evm-version cancun RewardManagerTest.sol IRewardManager.sol
