...
//go:generate sh -c "solc-v0.8.30 -o .. --overwrite --abi --pretty-json --evm-version cancun IWarpMessenger.sol && mv ../IWarpMessenger.abi ../contract.abi"
...
//go:generate go run github.com/ava-labs/libevm/cmd/abigen --pkg warpbindings --type IWarpMessenger --abi ../contract.abi --bin artifacts/IWarpMessenger.bin --out gen_iwarpmessenger_binding.go
