...
func TestContractNativeMinterRun(t *testing.T) {
	...
	for name, test := range map[string]test{
		...
		"enabled role by config": {
			...
			assertState: func(t *testing.T, state *state.StateDB) {
				require.Equal(t, allowlist.AllowListEnabled, GetContractNativeMinterStatus(state, testAddr))
			},
			config: &ContractNativeMinterConfig{
		...
		t.Run(name, func(t *testing.T) {
			...
			SetContractNativeMinterStatus(state, adminAddr, allowlist.AllowListAdmin)
			SetContractNativeMinterStatus(state, enabledAddr, allowlist.AllowListEnabled)
			SetContractNativeMinterStatus(state, noRoleAddr, allowlist.AllowListEnabled)
			require.Equal(t, allowlist.AllowListAdmin, GetContractNativeMinterStatus(state, adminAddr))
			require.Equal(t, allowlist.AllowListEnabled, GetContractNativeMinterStatus(state, enabledAddr))
			require.Equal(t, allowlist.AllowListEnabled, GetContractNativeMinterStatus(state, noRoleAddr))
