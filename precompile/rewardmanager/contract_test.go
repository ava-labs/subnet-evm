...
func TestRewardManagerRun(t *testing.T) {
	...
	for name, test := range map[string]test{
		...
		t.Run(name, func(t *testing.T) {
			...
			SetRewardManagerAllowListStatus(state, adminAddr, precompile.AllowListAdmin)
			SetRewardManagerAllowListStatus(state, enabledAddr, precompile.AllowListEnabled)
			SetRewardManagerAllowListStatus(state, noRoleAddr, precompile.AllowListNoRole)
