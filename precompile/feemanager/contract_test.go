...
func TestFeeConfigManagerRun(t *testing.T) {
	...
	for name, test := range map[string]test{
		...
		t.Run(name, func(t *testing.T) {
			...
			SetFeeConfigManagerStatus(state, adminAddr, precompile.AllowListAdmin)
			SetFeeConfigManagerStatus(state, enabledAddr, precompile.AllowListEnabled)
			SetFeeConfigManagerStatus(state, noRoleAddr, precompile.AllowListNoRole)
