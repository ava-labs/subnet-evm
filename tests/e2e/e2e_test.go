...
var _ = ginkgo.BeforeSuite(func() {
	...
	fmt.Println("Initializing runner")
	runner.InitializeRunner(logLevel, execPath, gRPCEp, networkRunnerLogLevel)
	runner.StartNetwork(vmID, vmName, vmGenesisPath, pluginDir)
})
