...
func TestE2E(t *testing.T) {
	...
	// TODO: register a subpackage containing the specs
}

var _ = ginkgo.Describe("[Fingers Crossed]", ginkgo.Ordered, func() {
	ginkgo.It("don't break it", ginkgo.Label("lol"), func() {
		log.Info("Wait wait don't tell me")
	})
})
