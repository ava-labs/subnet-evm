...
func TestRewardManagerPrecompileSetRewardAddress(t *testing.T) {
	...
	gas := 21000 + 240 + rewardmanager.PreDForkSetRewardAddressGasCost // 21000 for tx, 240 for tx data
...
func TestRewardManagerPrecompileAllowFeeRecipients(t *testing.T) {
	...
	gas := 21000 + 240 + rewardmanager.PreDForkAllowFeeRecipientsGasCost // 21000 for tx, 240 for tx data
