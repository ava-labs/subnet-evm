...
require (
	...
	github.com/ava-labs/avalanchego v1.14.1-0.20251203153608-b57ece0ca8a4
...
require (
	...
	github.com/ava-labs/avalanchego/graft/coreth v0.0.0-20251201152440-a263a7cedcd0 // indirect
